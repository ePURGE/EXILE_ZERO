...
/*edit*/
if(_itemClassName isEqualTo "CUP_srifle_M24_ghillie")then{_itemClassName = "CUP_srifle_M24_wdl";};
if(_itemClassName isEqualTo "CUP_srifle_SVD_wdl_ghillie")then{_itemClassName = "CUP_srifle_SVD";};
/*edit*/
